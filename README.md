...
Quick Python/Tkinter tool (~1000 lines) to edit Steam's `screenshots.vdf`: Add locations/tags ~~for Workshop uploads~~, preview images, per-AppID filter. Started with Arknights: Endfield screenshots (added as Non-Steam game). Pure weekend hack to test AI coding chat.
